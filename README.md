...
- Unlike most instruments, you can achieve a _reasonable_ approximation of [wind](https://www.soundonsound.com/techniques/synthesizing-wind-instruments) and [brass](https://www.soundonsound.com/techniques/synthesizing-brass-instruments) instruments through subtractive synthesis. If you don't want to work with VSTs, you can maintain a similar approach to this project and script a rough emulation of these acoustic systems for an investigation.
